...
import static main.Main.EXIT_NOERR;
import static main.Main.EXIT_PROGRAM_ERR;

class EnigmaMachine {

  static final String helpMessage
          = "THE ENIGMA MACHINE\n\n This program assumes you already " +
          "understand\n" +
          ...
          "outputs with the first number in the file representing an input " +
          "on\n" +
          ...
          "25 0\n" +
          "represents a mapping up one place in the Alphabet. With the rotor " +
          "in\n" +
          "the initial position, an 'A' will be mapped to 'B', a 'B' to " +
          "'C',\n" + "and 'Z' to 'A'.\n" +
          "Remember, this mapping will not hold after the first translation " +
          "as\n" +
          "the rotor will advance one position forward, with 'A' mapping to " +
          "'C'\n" +
          "and so on.\nFinally, the rotor file must contain exactly one each " +
          "of" +
          ...
          "numbers. These numbers again represent letters of the Alphabet, " +
          "and\n" +
          "represent which pairs of letters will be joined together on the\n" +
          "virtual plugboard of the enigma machine in this program. " +
          "Duplicates,\n" +
          "an odd number of numbers, incorrect spacing or numbers in the " +
          "wrong\n" +
          "range (0-25) will result in a syntax error or unexpected " +
          "behaviour." +
          "\n\n" +
          "USING THE PROGRAM\n\n" +
          "" +
          "Using the program is quite simple. Enter the message you want to\n" +
          "translate through your chosen configuration of rotors and " +
          "plugboard\n" +
          "and press ENTER. The result will then be shown below. You may " +
          "enter\n" +
          "further messages in the same way.\n" +
          "All messages must contain only the capital letters A-Z, and " +
          "spaces." +
          "If a message contains any other characters, they will be " +
          "replaced\n" +
          "by a dot (.) in the result. Note that invalid characters " +
          "do not\n" +
          "cause the rotors to change positions, as no translation has " +
          "taken\n" +
          "place.\n" +
          ...
          "encrypted version into an *identically* configured enigma " +
          "machine.\n" +
          "Remember also that the configuration of the machine includes " +
          "the\n" +
          "position of the rotors, which will change with every valid " +
          "character\n" +
          "entered.\n\n" +
          "" +
  ...
  EnigmaMachine(int[][] rotorMaps, int[] plugboardMap) {
    rotors = new Rotor[rotorMaps.length];
  ...
  private void startMachine() {
    System.out.println(
            "\n" +
                    ...
                    "Enter 'h' to see the help message, and 'q' at any time\n" +
                    "to exit the program\n\n" +
  ...
  private char translate(char c) {
    ...
    if (c == 'q') {
      ...
      System.exit(EXIT_NOERR);
    }
    if (c == 'h') {
      System.out.println("Printing help text:");
