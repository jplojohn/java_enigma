...
public class RotorTest {
	...
	public void basicBackwardRotorTest() {
		...
		assertThat(myRotor1.translateBackwards('F'), is('F'));
		assertThat(myRotor1.translateBackwards('D'), is('E'));
	}
	...
	public void basicBackwardsRotor5Test() {
		...
		assertThat(myRotor5.translateBackwards('D'), is('B'));
		assertThat(myRotor5.translateBackwards('D'), is('C'));
	}
